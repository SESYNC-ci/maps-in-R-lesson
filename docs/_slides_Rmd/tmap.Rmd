...
```{r qtmap_data, title = "worksheet-1.R"}
...
```{r tmap_layer, title = "worksheet-1.R"}
...
```{r tmap_show, title = "worksheet-1.R"}
map1
```
...
```{r tmap_add, title = "worksheet-1.R"}
map1 +
